...
class Bingo {
	...
	void drawBalls() {
		...
		Board* last_winning_board = nullptr;
		...
		// Use last winning board to do the calculations
		int sum = last_winning_board->calculateSumOfUnmarkedNumbers();
		int ball = last_winning_board->getWinningBall();
		int answer = sum * ball;
...
int main(int argc, char *argv[]) {
	...
	if (argc != 2) {
		cout << "Usage: day4b <input.txt>" << endl;
		return -1;
	}
